 ...
 *COEN 317 Lab 3 : Discrete Write number of Clock Cycle Calculation
 */

/*This program perform a discrete write on LED's using a GPIO and a predefined write funciton, supplied
by the Xilinx Library. The amount of clock cycles required is calculed using the AXI Timer.*/
#include "stdbool.h"
